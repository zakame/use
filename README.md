...
current workhorse is a heavily upgraded X220 with 16G RAM and 2 250GB
SSDs; previously, I was using an X200 and X61.  All of these are
second-hand units, and I also have some few dead T61s I have collected
at home.  I also have T420 for use @$WORK (more on that below,) and also
used to have an ASUS 1215B netbook (previously for gaming on the go, but
now given to my folks for their own computing needs.)  There's also that
...
At my work, I am assigned a ThinkPad T420 with HD+ screen, 16G RAM, and
128G SSD, with a ViewSonic monitor to go with it.  I've brought my SSK
to use as my main keyboard, with the M13 swapping in occasionally.  So
far, so good :-)
...
all my machines run either the latest stable (Slackware64-14.2) or the
...
For editing, I prefer [Emacs](http://www.gnu.org/s/emacs); I've put
my [.emacs.d](https://github.com/zakame/.emacs.d) up on GitHub.  I also
use that for reading Usenet, via Gnus.  I'm a heavy user of Org-Mode for
both general document writing and to-do tasks, and over the years I've
customized my setup beyond just supporting Perl programming, to getting
around modern web development with JavaScript and Go.

Being a Perl programmer, I tend to have a local copy of the CPAN on my
machines, thanks to the wonder that is Ricardo
SIGNES' [CPAN::Mini](http://metacpan.org/module/CPAN::Mini), a local
build of various Perl versions, using Tokuhiro
Matsuno's [plenv](https://github.com/tokuhirom/plenv), and Tatsuhiko
Miyagawa's [Carton](http://metacpan.org/module/Carton) to manage modules
in deployment environments.  Slackware (which I also mirror locally,
...
A large part of my dream setup is already real (classic ThinkPads +
clicky keyboards + a Linux that just works.)  Can't hurt to want some
minor updates though, like maybe 64+ core CPU and a cool
(temperature-wise) discrete graphics multicores on a larger-resolution
ThinkPad.
